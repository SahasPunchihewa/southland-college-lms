						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								<ul class="main_nav">
									...
									<li class="active"><a href="#">Staff Login</a></li>
								</ul>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							...
							?>
							<form action="login_process.php" class="comment_form" method="POST">
								<div>
									<div class="form_title">Username</div>
									<input type="text" class="comment_input" required="required" name="username">
								</div>
								<div>
